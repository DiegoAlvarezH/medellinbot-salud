    ...
    <footer className="border-t border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900">
      <div className="container mx-auto px-4 py-12">
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-2">
                <Mail className="w-4 h-4 mt-0.5 flex-shrink-0 text-gray-600 dark:text-gray-400" />
                <a
                  href="mailto:info@medellinbot.co"
                  className="text-sm text-gray-600 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 transition-colors"
                >
                  info@medellinbot.co
                </a>
              ...
              <div className="flex items-start gap-2">
                <MapPin className="w-4 h-4 mt-0.5 flex-shrink-0 text-gray-600 dark:text-gray-400" />
                <span className="text-sm text-gray-600 dark:text-gray-300">
                  Medellín, Colombia
                </span>
              </div>
              <div className="flex items-start gap-2">
                <Phone className="w-4 h-4 mt-0.5 flex-shrink-0 text-gray-600 dark:text-gray-400" />
                <span className="text-sm text-gray-600 dark:text-gray-300">
                  Emergencias: 123
                </span>
              </div>
        ...
        <div className="border-t border-gray-200 dark:border-gray-800 pt-8 mb-6">
          <div className="glass dark:glass rounded-2xl p-6 border border-yellow-200 dark:border-yellow-800/50">
