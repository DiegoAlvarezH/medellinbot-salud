...
export function HowItWorksSection() {
  ...
  return (
    <section className="py-20 px-4 bg-secondary-50 dark:bg-secondary-950">
      <div className="container mx-auto">
        ...
        >
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 text-secondary-900 dark:text-white">
            ¿Cómo <span className="text-primary-600 dark:text-primary-500">funciona?</span>
          </h2>
          ...
          {steps.map((step, index) => (
            ...
            >
              ...
              <div className="relative flex-shrink-0">
                <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-primary-600 to-secondary-600 flex items-center justify-center shadow-lg">
                  <span className="text-3xl font-bold text-white">
                    {step.number}
                  </span>
                </div>
                {index < steps.length - 1 && (
                  <div className="absolute top-full left-1/2 -translate-x-1/2 w-0.5 h-12 bg-primary-200 dark:bg-primary-900/30 mt-4" />
                )}
              </div>
              ...
              <div className="flex-1 pt-2">
                <div className="glass-panel rounded-2xl p-6 hover:shadow-xl transition-shadow">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <h3 className="text-2xl font-bold text-secondary-900 dark:text-white">{step.title}</h3>
                  </div>
